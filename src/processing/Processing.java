...
public class Processing {
	...
	public Mat fourierTransform(Mat image) {
		...
		// add zero
		// values
		Core.copyMakeBorder(image, padded, (addPixelRows - image.height()) / 2, (addPixelRows - image.height()) / 2,
				(addPixelCols - image.width()) / 2, (addPixelCols - image.width()) / 2, Core.BORDER_CONSTANT,
				Scalar.all(0));
